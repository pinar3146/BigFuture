...
public class BrowserUtils {
    ...
    public static void switchToWindow(String targetTitle) {
        String origin = com.vytrack.utilities.Driver.get().getWindowHandle();
        for (String handle : com.vytrack.utilities.Driver.get().getWindowHandles()) {
            com.vytrack.utilities.Driver.get().switchTo().window(handle);
            if (com.vytrack.utilities.Driver.get().getTitle().equals(targetTitle)) {
                return;
            }
        }
        com.vytrack.utilities.Driver.get().switchTo().window(origin);
    }
    ...
    public static void hover(WebElement element) {
        Actions actions = new Actions(com.vytrack.utilities.Driver.get());
    ...
    public static List<String> getElementsText(By locator) {
        ...
        List<WebElement> elems = com.vytrack.utilities.Driver.get().findElements(locator);
        List<String> elemTexts = new ArrayList<>();
    ...
    public static WebElement waitForVisibility(WebElement element, int timeToWaitInSec) {
        WebDriverWait wait = new WebDriverWait(com.vytrack.utilities.Driver.get(), timeToWaitInSec);
    ...
    public static WebElement waitForVisibility(By locator, int timeout) {
        WebDriverWait wait = new WebDriverWait(com.vytrack.utilities.Driver.get(), timeout);
    ...
    public static void waitForPageToLoad(long timeOutInSeconds) {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(com.vytrack.utilities.Driver.get(), timeOutInSeconds);
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assert.assertTrue("Element not visible: " + by, com.vytrack.utilities.Driver.get().findElement(by).isDisplayed());
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            Assert.assertFalse("Element should not be visible: " + by, com.vytrack.utilities.Driver.get().findElement(by).isDisplayed());
        } catch (NoSuchElementException e) {
            e.printStackTrace();
